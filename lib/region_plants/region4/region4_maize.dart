...
class MaizeRegion4 extends StatefulWidget {
  static const String id = 'MaizeRegion4';
  const MaizeRegion4({Key key}) : super(key: key);
  @override
  _MaizeRegion4State createState() => _MaizeRegion4State();
}

class _MaizeRegion4State extends State<MaizeRegion4> {
...
For more information visit: https://www.seedcogroup.com/zw/farmer-s-hub/maize/region-4''',
                    style: TextStyle(
                      fontSize: 15,
                    ),
                  )),
