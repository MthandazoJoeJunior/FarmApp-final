...
class MaizeRegion3 extends StatefulWidget {
  static const String id = 'MaizeRegion3';
  const MaizeRegion3({Key key}) : super(key: key);
  @override
  _MaizeRegion3State createState() => _MaizeRegion3State();
}

class _MaizeRegion3State extends State<MaizeRegion3> {
  bool showSpinner = false;
  // const MaizeRegion3State({Key? key}) : super(key: key);
...
For more information visit: https://www.seedcogroup.com/zw/farmer-s-hub/maize/region-3''',
                    style: TextStyle(
                      fontSize: 15,
                    ),
                  )),
