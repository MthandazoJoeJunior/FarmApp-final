...
class MaizeRegion2 extends StatefulWidget {
  static const String id = 'MaizeRegion2';
  const MaizeRegion2({Key key}) : super(key: key);
  @override
  _MaizeRegion2State createState() => _MaizeRegion2State();
}

class _MaizeRegion2State extends State<MaizeRegion2> {
  bool showSpinner = false;
  // const MaizeRegion2State({Key? key}) : super(key: key);
