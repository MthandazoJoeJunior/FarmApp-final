...
class GroundNutsRegion2 extends StatefulWidget {
  static const String id = 'GroundNutsRegion2';
  const GroundNutsRegion2({Key key}) : super(key: key);
  @override
  _GroundNutsRegion2State createState() => _GroundNutsRegion2State();
}

class _GroundNutsRegion2State extends State<GroundNutsRegion2> {
