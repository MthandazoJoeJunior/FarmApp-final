...
class PotatoesScreen extends StatefulWidget {
  static const String id = 'potatoesscreen';
  const PotatoesScreen({Key key}) : super(key: key);
  @override
  _PotatoesScreenState createState() => _PotatoesScreenState();
}

class _PotatoesScreenState extends State<PotatoesScreen> {
