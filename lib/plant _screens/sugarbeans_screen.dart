...
class SugarBeansScreen extends StatefulWidget {
  static const String id = 'sugarbeansscreen';
  const SugarBeansScreen({Key key}) : super(key: key);
  @override
  _SugarBeansScreenState createState() => _SugarBeansScreenState();
}

class _SugarBeansScreenState extends State<SugarBeansScreen> {
