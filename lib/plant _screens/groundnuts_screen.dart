...
class GroundnutsScreen extends StatefulWidget {
  static const String id = 'groundnutsscreen';
  const GroundnutsScreen({Key key}) : super(key: key);
  @override
  _GroundnutsScreenState createState() => _GroundnutsScreenState();
}

class _GroundnutsScreenState extends State<GroundnutsScreen> {
